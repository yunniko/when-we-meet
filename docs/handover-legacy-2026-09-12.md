...
Shared-server access and safety invariants live in
`E:\CLAUDE\COMPANY\INFRASTRUCTURE.md`; the site/port inventory and the
"don't affect other sites" rules live in
`E:\CLAUDE\COMPANY\INFRASTRUCTURE_DEPLOY.md` (added 2026-08-23, split from
the former into core vs. on-demand deploy detail on 2026-09-06) — those are
the canonical cross-project references; the narrative below is this
project's own decision record for how it got set up.
